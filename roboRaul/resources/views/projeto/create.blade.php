                ...
                <div class="card card-primary">
                    ...
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputAluno"
                                    placeholder="Insira o(s) nome(s) do(s) aluno(s) responsável(veis) pelo projeto">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputGit"
                        ...
                        <div class="card-footer">
                            ...
                            <button type="reset" class="btn btn-warning" id="btnLimpar">Limpar</button>
                        </div>
                    </form>
                </div>
                <!-- /.card -->
